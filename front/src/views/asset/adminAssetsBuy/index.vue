  ...
  <div class="search">
        ...
        <Form ref="searchForm" :model="searchForm" inline :label-width="0">
          ...
          >
            ...
            <Form-item style="position: fixed; right: 50px; top: 110px">
              ...
              <!-- 使用教程内容弹窗 -->
              <Modal v-model="modal1" title="使用教程"> </Modal>
            </Form-item>
          </Form-item>
        </Form>
      </Row>
    ...
    >
      <Form inline :label-width="90">
        ...
        <Divider dashed
          ><span class="lookMoreFont">↓↓↓请填写以下信息↓↓↓</span></Divider
        >
        <Row :gutter="16">
          <Col span="24">
            <Form-item label="入库数量" style="width: 98%">
              <InputNumber
                :max="selectRow.quantity2"
                :min="1"
                v-model="inAssetsNumber"
                style="width: 100%"
              ></InputNumber>
            </Form-item>
          </Col>
        ...
        <Row :gutter="16">
          <Col span="24">
            <Form-item label="采购日期" style="width: 98%">
              <DatePicker
                type="date"
                :placeholder="inAssetsDate"
                style="width: 100%"
                format="yyyy-MM-dd"
                @on-change="changeInAssetsDate"
              ></DatePicker>
            </Form-item>
          </Col>
        </Row>
